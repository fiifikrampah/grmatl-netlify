...
import { Heart, Building, DollarSign, Copy, Check, CreditCard, RefreshCw, Shield, Smartphone, ArrowUpRight } from 'lucide-react'
      ...
      <CardContent className="p-6 md:p-8 text-center flex flex-col h-full">
        ...
        <div className="w-full flex-grow flex flex-col justify-end min-h-[100px] md:min-h-[140px]">
          <div className="space-y-4">
            ...
            <a href="https://give.tithe.ly/?formId=1f6a8698-6865-11ee-90fc-1260ab546d11" target="_blank" rel="noopener noreferrer" className="block w-full">
              <Button
              ...
              >
                Give via Tithe.ly <ArrowUpRight className="ml-2 h-5 w-5" />
              </Button>
            </a>
          </div>
        </div>
